...
export default function Testimonials() {
  ...
  return (
      ...
      {/* Testimonials Grid */}
        <div className="w-full px-16 columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
        {testimonials.map((t, index) => (
            <div
            key={index}
            className="break-inside-avoid border border-gray-300 gap-2 rounded-[30px] bg-white shadow-sm p-6 flex flex-col justify-between"
            >
            {/* 1️⃣ User Info */}
            ...
            <div className="flex flex-col text-left gap-5 flex-1">
                ...
                <h3 className="font-semibold text-black text-[22px] leading-snug">{t.title}</h3>
                <p className="text-[#64698e] text-[20px] font-medium leading-relaxed">{t.text}</p>
            </div>
