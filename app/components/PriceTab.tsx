...
{/* ------------------------------------------------Seed---------------------------------------- */}
                          ...
                          <div className="flex flex-col pl-5 pr-4 pt-3 pb-6 gap-0 border-2  border-black rounded-[10px] xl:border-r-0 xl:rounded-tr-none xl:rounded-br-none xl:mr-[-7px] md:mr-0 md:border-2 md:rounded-[10px]">
                             <h4 className="text-[40px] text-black text-bold">Growth</h4>
                              ...
                              <ul className="flex flex-col gap-4 py-5">
                                  ...
                                  <li className="flex justify-between items-center content-center"><div className="flex gap-3"><span className="flex items-center justify-center text-[14px] bg-[#7A63DF33] text-[#7A63DF] max-h-7 w-7 p-2 rounded-[100px]">✓</span>Video to Article</div><span className="text-[13px] py-1 px-2 bg-[#b9b9b933] text-[#686868] rounded-[100px] min-w-[95px]">Coming Soon</span></li>
                                  <li className="flex justify-between items-center content-center gap-3"><div className="flex gap-3"><span className="flex items-center justify-center text-[14px] bg-[#7A63DF33] text-[#7A63DF] max-h-7 w-7 p-2 rounded-[100px]">✓</span>AI Article Updater</div><span className="text-[13px] py-1 px-2 bg-[#b9b9b933] text-[#686868] rounded-[100px] min-w-[95px]">Coming Soon</span></li>
                                  <li className="flex justify-between items-center content-center gap-3"><div className="flex gap-3"><span className="flex items-center justify-center text-[14px] bg-[#7A63DF33] text-[#7A63DF] max-h-7 w-7 p-2 rounded-[100px]">✓</span>AI Auto Technical SEO</div><span className="text-[13px] py-1 px-2 bg-[#b9b9b933] text-[#686868] rounded-[100px] min-w-[95px]">Coming Soon</span></li>
                                  <li className="flex justify-between items-center content-center gap-3"><div className="flex gap-3"><span className="flex items-center justify-center text-[14px] bg-[#7A63DF33] text-[#7A63DF] max-h-7 w-7 p-2 rounded-[100px]">✓</span>AI Internal Links Builder</div><span className="text-[13px] py-1 px-2 bg-[#b9b9b933] text-[#686868] rounded-[100px] min-w-[95px]">Coming Soon</span></li>
                                  <li className="flex justify-between items-center content-center gap-3"><div className="flex gap-3"><span className="flex items-center justify-center text-[14px] bg-[#7A63DF33] text-[#7A63DF] max-h-7 w-7 p-2 rounded-[100px]">✓</span>GMB SEO Tracker</div><span className="text-[13px] py-1 px-2 bg-[#b9b9b933] text-[#686868] rounded-[100px] min-w-[95px]">Coming Soon</span></li>
                                  <li className="flex justify-between items-center content-center gap-3"><div className="flex gap-3"><span className="flex items-center justify-center text-[14px] bg-[#7A63DF33] text-[#7A63DF] max-h-7 w-7 p-2 rounded-[100px]">✓</span>AI SEO Tracker</div><span className="text-[13px] py-1 px-2 bg-[#b9b9b933] text-[#686868] rounded-[100px] min-w-[95px]">Coming Soon</span></li>
                          ...
                          {/* --------------------------------Growth Max---------------------------------------- */}
                          <div className="flex flex-col pl-5 pr-3 pt-3 pb-6 xl:pr-3 md:pr-4 gap-0 bg-[#ffffe6] border-4 border-[#2e64fe] rounded-[10px]">
                              ...
                              <div className="w-full min-w-full justify-center flex items-center content-center">
                                  <button className="w-fit mt-5 bg-[#2e64fe] text-center text-[18px] py-2.5 px-[60px] border-[#2e64fe] border-solid border-[1px] text-white rounded-[100px] hover:bg-[#2E64FE] hover:text-white hover:border-[#2E64FE] hover:-translate-y-2 focus:bg-[#2E64FE] focus:text-white focus:border-[#2E64FE] focus:-translate-y-2 transition-transform duration-300"><a>PROCEED</a></button>
                              </div>
                          </div>
...
{/* ------------------------------------------------Seed---------------------------------------- */}
                          ...
                          {/* --------------------------------Growth Max---------------------------------------- */}
                          <div className="flex flex-col pl-5 pr-3 xl:pr-3 md:pr-4 pt-3 pb-6 gap-0 bg-[#ffffe6] border-4 border-[#2e64fe] rounded-[10px]">
                              <h4 className="text-[40px] text-black text-bold">Growth Max</h4>
